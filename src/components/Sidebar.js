...
import services from "../api/services/api_user.js";
...
import {
  sidebarRoutesbroker as brokerroutes,
  sidebarRoutessme as smeroutes,
  sidebarRoutesadmin as adminroutes,
} from "../routes/index";
...
const Sidebar = ({ classes, staticContext, location, ...rest }) => {
  ...
  const { data = { data: { "": "" } } } = useQuery("fetchUserData", () =>
  ...
  return (
    <Drawer variant="permanent" {...rest}>
      <Brand component={NavLink} to="/" button>
        <BrandIcon /> <Box ml={1}>PROTOSLABS</Box>
      </Brand>
      <Scrollbar>
        <List disablePadding>
          <Items>
        ...
        <Grid container spacing={2}>
          <Grid item>
            <SidebarFooterBadge
              ...
              variant="dot"
            >
              <Avatar alt="Avatar" src="/static/img/avatars/avatar-blank.jpg" />
            </SidebarFooterBadge>
          </Grid>
          <Grid item>
