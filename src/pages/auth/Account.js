...
const Account = (props) => {
  ...
  //resend confirmation code to user's email for verification
  ...
  //resend confirmation code to user's email for forget password flow
  const resendForgetPasswordCode = async () => {
    return await new Promise((resolve, reject) => {
      const user = new CognitoUser({
        Username: email,
        Pool: UserPool,
