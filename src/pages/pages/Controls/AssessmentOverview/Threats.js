...
// function createData(threatScenario, id, uuid) {
//   let link = "/threatscenario?id=" + id + "&vendor=" + uuid;
//   return { threatScenario, id, link };
// }
...
//     createData(scenario.threatScenario, scenario.id, props.uuid.uuid)
//   );
//   console.log(rows);
