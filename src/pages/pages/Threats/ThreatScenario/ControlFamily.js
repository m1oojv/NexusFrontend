...
// // Data
// let id = 0;
// function createData(source, users, sessions, bounce, uuid) {
//   id += 1;
//   console.log(source);
//   let link =
//     "/controls/controlfamilydetails?id=" +
//     source.toString().replace(/\s/g, "+").replace(/&/g, "%26") +
//     "&vendor=" +
//     uuid;
//   return { id, source, users, sessions, bounce, link };
// }
...
// const TrafficTable = ({ controlScore, uuid }) => {
//   let rows = [];
